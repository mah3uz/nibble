...
Rails.application.configure do
  ...
  # Store uploaded files on Amazon S3 (see config/storage.yml; staging inherits this).
  ...
  # Skip http-to-https redirect for the health check endpoint (Kamal proxy calls /up over HTTP).
