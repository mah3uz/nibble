module Admin
  class RevisionsController < BaseController
    ...
    def restore
      ...
      result = Nibble::Lifecycle.call(@entry, :revert, { "revision_id" => params[:id], "lock_version" => params[:lock_version] }, actor: Current.user)
    ...
    def edit_path = edit_admin_collection_entry_path(@collection.handle, @entry)
  end
end
