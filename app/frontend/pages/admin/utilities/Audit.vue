...
useBreadcrumbs([{ label: 'Utilities', url: '/admin/utilities' }, { label: 'Audit log' }])
</script>
...
<template>
  <div>
    <PageHeader
      title="Audit log"
      icon="history"
      :breadcrumbs="[{ label: 'Utilities', url: '/admin/utilities' }, { label: 'Audit log' }]"
    />

    <AdminPanel title="Activity" description="Every recorded action, newest first." flush>
