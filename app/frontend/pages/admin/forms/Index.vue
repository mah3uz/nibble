  ...
  <div class="mx-auto max-w-5xl">
    <div v-if="!forms.length" class="mx-auto max-w-md py-14">
      <h1 class="mb-8 flex items-center justify-center gap-3 text-[25px] font-medium">
        <AdminIcon name="forms" class="size-5 text-gray-500" />Forms
      </h1>
      <div class="rounded-2xl bg-gray-150 p-1.5 dark:bg-gray-950/35">
        ...
        <div class="space-y-6 rounded-xl bg-white p-5 shadow-ui-sm dark:bg-gray-900">
          <div class="flex gap-4">
            <AdminIcon name="forms" class="mt-0.5 size-5 text-gray-500" />
            <div>
          ...
          <div class="flex gap-4">
            <AdminIcon name="globals" class="mt-0.5 size-5 text-gray-500" />
            <div>
              <Link href="/admin/globals/integrations/edit" class="font-medium hover:underline">Configure email</Link>
              <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
