...
<template>
  <Card>
    ...
    <CardContent>
      <form class="space-y-4" @submit.prevent="form.post('/admin/session')">
        <div class="space-y-2">
        ...
        <p class="text-center text-sm">
          <Link href="/admin/passwords/new" class="text-muted-foreground hover:underline">Forgot password?</Link>
        </p>
      </form>
    </CardContent>
  </Card>
