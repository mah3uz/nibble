...
class Admin::SearchTest < ActionDispatch::IntegrationTest
  ...
  test "the palette finds records by title, drafts included" do
    ...
    get "/admin/search", params: { q: "pricing" }
    ...
    assert_equal "/admin/collections/articles/entries/#{draft.id}/edit", articles["items"].first["url"]
  ...
  test "trashed records are not offered" do
    ...
    get "/admin/search", params: { q: "thrown" }
