...
class Admin::BulkAssignTermsTest < ActionDispatch::IntegrationTest
  ...
  test "the chosen term reaches every selected entry" do
    ...
    post "/admin/actions", params: { resource: "collections.articles", handle: "assign_tags",
  ...
  test "an assignment with no term chosen changes nothing" do
    ...
    post "/admin/actions", params: { resource: "collections.articles", handle: "assign_tags", ids: [ article.id ], values: {} }
