...
class Nibble::Cp::NibbleApi::PlaygroundControllerTest < ActionDispatch::IntegrationTest
  ...
  def validate(values) = post(cp_nibble_playground_validate_path, params: { blueprint: "kitchen_sink", values: }, as: :json)
  ...
  test "the page renders the blueprint in publish shape with defaults and meta" do
    get cp_nibble_playground_path, params: { blueprint: "kitchen_sink" }
