...
class Nibble::Cp::CommentsTest < ActionDispatch::IntegrationTest
  ...
  test "an editorial note threads under its parent and stays on the record" do
    ...
    path = "/cp/collections/articles/entries/#{entry.id}/comments"
  ...
  test "a mention tells the person they were mentioned, and the mentioner hears nothing" do
    ...
    post "/cp/collections/articles/entries/#{entry.id}/comments",
