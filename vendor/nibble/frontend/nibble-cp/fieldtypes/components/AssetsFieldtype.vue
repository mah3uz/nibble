...
import AssetEditor from '@/components/cp/assets/AssetEditor.vue'
import AssetSelector from '@/components/cp/assets/AssetSelector.vue'
import FileIcon from '@/components/cp/assets/FileIcon.vue'
import { useUploads } from '@/components/cp/assets/useUploads'
...
<template>
  ...
  >
    ...
    >
      <CpIcon name="upload-cloud" class="size-5" />
    ...
    >
      <Button
        ...
        ><CpIcon name="folder" /><span class="@sm:hidden">Browse</span
      ...
      >
        <CpIcon name="upload-cloud" class="size-5 @max-sm:hidden" />
