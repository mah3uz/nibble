...
useBreadcrumbs([{ label: 'Utilities', url: '/cp/utilities' }, { label: 'Health' }])
</script>
...
<template>
  <div>
    <PageHeader
      title="Health"
      icon="health"
      :breadcrumbs="[{ label: 'Utilities', url: '/cp/utilities' }, { label: 'Health' }]"
    >
      <template #meta>
    ...
    <CpPanel title="Checks" :description="`Checked at ${time(checked_at)}`" flush>
      <div class="text-sm">
        <div
