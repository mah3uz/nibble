...
<template>
  <div class="nib-find" role="search" aria-label="Find and replace">
    <div class="flex items-center gap-1">
      ...
      >
        <CpIcon :name="showReplace ? 'chevron-down' : 'chevron-right'" class="size-4!" />
      </Button>
      ...
      >
        <CpIcon name="chevron-up" class="size-4!" />
      </Button>
      <Button
        type="button"
        variant="ghost"
      ...
      >
        <CpIcon name="chevron-down" class="size-4!" />
      </Button>
      <Button
        type="button"
        variant="ghost"
