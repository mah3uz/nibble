...
async function start() {
  router.post('/cp/account/two_factor', {}, { preserveScroll: true })
}

async function confirm() {
  confirmForm.post('/cp/account/two_factor/confirm', {
    preserveScroll: true,
...
async function submitPassword() {
  const url = asking.value === 'disable' ? '/cp/account/two_factor' : '/cp/account/two_factor/recovery_codes'
  const options = {
    preserveScroll: true,
    onSuccess: () => {
      asking.value = null
...
async function keptCodes() {
  ...
  void fetch('/cp/account/two_factor/recovery_codes/ack', {
    method: 'POST',
