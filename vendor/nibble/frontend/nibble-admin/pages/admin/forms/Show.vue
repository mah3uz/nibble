...
function exportSubmissions() {
  ...
  window.open(`/admin/forms/${props.form.handle}.csv${query}`, '_blank')
...
<template>
  <div class="mx-auto max-w-5xl space-y-6">
    <PageHeader
      :title="form.title"
      icon="forms"
      :breadcrumbs="[{ label: 'Forms', url: '/admin/forms' }, { label: form.title }]"
    >
      <template #actions>
    ...
    <AdminListing :listing="listing" :exportable="false" @row-click="open">
