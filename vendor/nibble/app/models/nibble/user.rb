module Nibble
  class User < Nibble::ApplicationRecord
    self.table_name = "nibble_users"

    include Nibble::TwoFactor
    ...
    def an_administrator_remains
      return unless admin? && Nibble::User.administrators.where.not(id: id).none?
